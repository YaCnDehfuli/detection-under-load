...
|---|---|---|
| [Dumpert IMPHASH correction](dumpert-imphash-correction.md) | The recorded executable form misses the hash branch because an import hash is labeled as an MD5; the separate `Dumpert.dll` command-line branch can still match other forms. | **Opened — [SigmaHQ/sigma#6311](https://github.com/SigmaHQ/sigma/pull/6311)** |
